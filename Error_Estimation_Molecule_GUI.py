...
import est_error_molecule as Error_est_barcode
...
class Error_Estimation_GUI(Tkinter.Frame):
    ...
    def submit(self):
        ...
        error_inst = Error_est.ErrorEstimation_SUBS(self.fasta, self.target_fa, self.output_file_name)
        error_inst = Error_est.ErrorEstimation_DEL(self.fasta, self.target_fa, self.output_file_name)
        error_inst = Error_est.ErrorEstimation_INS(self.fasta, self.target_fa, self.output_file_name)
        error_inst.Process()
